...
\begin{itemize}[itemsep=0pt,partopsep=1pt,parsep=1pt]
	...
	\item inserire il corpo delle funzioni sia tramite riga di comando che da file
...
\begin{itemize}[itemsep=0pt,partopsep=1pt,parsep=3pt]
	...
	\item \verb"WStype_TEXT": questo tipo è il più diffusso, infatti identifica tutti quei messaggi che vengono scambiati tra client e server durante le loro interazioni.
...
\begin{enumerate}
	\item Nel primo test si è impostato un valore di soglia pari a 6 per tutti e tre i sensori e sono state condotte 10 simulazioni per ogni parcheggio. Per ogni simulazione si è verificato il corretto funzionamento del sensore.
