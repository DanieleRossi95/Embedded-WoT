...
struct SQFuncState
{
...
#else
    SQFuncState(SQFuncState *parent,CompilerErrorFunc efunc,void *ed) ;
#endif
    ~SQFuncState() ;
#ifdef _DEBUG_DUMP
    ...
    SQObject CreateString(const SQChar *s,SQInteger len, SQBool isConst) ;
