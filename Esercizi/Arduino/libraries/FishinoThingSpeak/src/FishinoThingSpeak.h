...
#ifndef FishinoThingSpeak_h
#define FishinoThingSpeak_h

//#define PRINT_DEBUG_MESSAGES
//#define PRINT_HTTP


#if defined(FISHINO_WIFI)
#include <Fishino.h>
#elif defined(ARDUINO_ARCH_AVR) || defined(ARDUINO_ARCH_ESP8266) || defined(ARDUINO_ARCH_SAMD) || defined(ARDUINO_ARCH_SAM)
#include "Arduino.h"
#include <Client.h>
#else
#error Only Fishino, Arduino MKR1000, Yun, Uno/Mega/Due with either WiFi101 or Ethernet shield. ESP8266 also supported.
#endif
...
#if defined(FISHINO_UNO)
	#define TS_USER_AGENT "tslib-arduino/1.3 (FISHINO UNO)"
#elif defined(FISHINO_MEGA)
	#define TS_USER_AGENT "tslib-arduino/1.3 (FISHINO MEGA)"
#elif defined(FISHINO_GUPPY)
	#define TS_USER_AGENT "tslib-arduino/1.3 (FISHINO GUPPY)"
#elif defined(FISHINO32) || defined(FISHINO32_96M)
	#define TS_USER_AGENT "tslib-arduino/1.3 (FISHINO32)"
#elif defined(FISHINO_PIRANHA) || defined(FISHINO_PIRANHA_96M)
	#define TS_USER_AGENT "tslib-arduino/1.3 (FISHINO PIRANHA)"
#elif defined(FISHINO32_M_PROTO)
	#define TS_USER_AGENT "tslib-arduino/1.3 (FISHINO32 PROTOTYPE)"
...
#ifdef PRINT_DEBUG_MESSAGES
					Serial.print("               Connect to ");
					Serial.print(this->customHostName);
					Serial.print(" ...");
#endif
